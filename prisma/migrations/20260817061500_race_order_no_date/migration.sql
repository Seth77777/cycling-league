...
INSERT INTO "new_Race" ("id", "name", "country", "season", "categoryId", "resultKind", "parentRaceId", "stageNumber", "isTimeTrial", "jerseyName")
SELECT "id", "name", "country", "season", "categoryId", "resultKind", "parentRaceId", "stageNumber", "isTimeTrial", "jerseyName" FROM "Race";
DROP TABLE "Race";
